...
const productos = [
{id: 1, nombre: "producto n°1", stock: 10},
{id: 2, nombre: "producto n°2", stock: 5},
{id: 3, nombre: "producto n°3", stock: 15},
];
...
router.delete("/:id", (req, res) => {
    ...
    //splice encuentra el producto en el array y luego de la coma pongo q borre un elemento
